...
Follow [this instruction](https://github.com/KhoiVuKha/Project-Casting-Agency/blob/main/Instruction-to-Render-Cloud-Platform/README.md) to deploy Flask App to Render Cloud.
